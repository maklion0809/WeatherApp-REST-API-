...
class Router<T: EndPoint>: NetworkRouter {
    ...
    private func buildRequest(from route: T) throws -> URLRequest {
        
        guard let url = URL(string: route.path, relativeTo: route.baseURL) else { throw NetworkError.encodingFailed }
